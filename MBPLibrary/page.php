            ...
            foreach ($lectures as $lecture) {
                ...
                <div class='modal' id='<?php echo $modalname ?>'>
                    <div class='modal-content'>
                        ...
                        <hr>
                        <h5>Download:</h5>
                        <?php if(file_exists($lecture_media_link)){ ?><p><a href='<?php echo $lecture_media_link ?>' download class='btn waves-effect waves-blue blue'>Audio
                                File</a></p><?php }?>
                        <?php if(file_exists($lecture_text_link)){ ?><p><a href='<?php echo $lecture_text_link ?> ' download class='btn waves-effect waves-blue blue'>Original script
                                File</a></p><?php }?>
                        <?php if(file_exists($lecture_sync_link)){ ?><p><a href='<?php echo $lecture_sync_link ?> ' download class='btn waves-effect waves-blue blue'>Sync
                                file</a></p><?php } ?>
                        ...
                        <div class="row">
                            <div class="input-field col s6 m4 offset-m2">
                                <select id="lecture_diff" name="lecture_diff" required>
                                    ...
                                    <option value="1" <?php if (isset($_POST['lecture_diff']) && $_POST['lecture_diff'] == 1) echo "selected" ?>>A
                                    </option>
                                    <option value="2" <?php if (isset($_POST['lecture_diff']) && $_POST['lecture_diff'] == 2) echo "selected" ?>>B
                                    </option>
                                    <option value="3" <?php if (isset($_POST['lecture_diff']) && $_POST['lecture_diff'] == 3) echo "selected" ?>>C
                                    </option>
                                </select>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="input-field col s6 m4 offset-m2">
                                <select id="lecture_diff" name="lecture_diff" required>
                                    <option value="" selected disabled>Choose level of difficulty...</option>
                                    <option value="1" <?php if($_SESSION['id'] != $lec['data']['user_id'] and $_SESSION['admin'] == 0 and $lec['data']['difficulty'] != 1) echo "disabled" ?> <?php if (isset($_POST['lecture_diff']) && $_POST['lecture_diff'] == 1 or $lec['data']['difficulty'] == 1) echo "selected" ?>>A
                                    </option>
                                    <option value="2" <?php if($_SESSION['id'] != $lec['data']['user_id'] and $_SESSION['admin'] == 0 and $lec['data']['difficulty'] != 2) echo "disabled" ?> <?php if (isset($_POST['lecture_diff']) && $_POST['lecture_diff'] == 2 or $lec['data']['difficulty'] == 2) echo "selected" ?>>B
                                    </option>
                                    <option value="3" <?php if($_SESSION['id'] != $lec['data']['user_id'] and $_SESSION['admin'] == 0 and $lec['data']['difficulty'] != 3) echo "disabled" ?> <?php if (isset($_POST['lecture_diff']) && $_POST['lecture_diff'] == 3 or $lec['data']['difficulty'] == 3) echo "selected" ?>>C
                                    </option>
                                </select>
                                <label>Difficulty level</label>
                            </div>
                        ...
                        <div class="row">
                            <div class="col s5 offset-s2">
                                <a href="<?php echo $lec['data']['audio_link'] ?>" download class="btn grey" style="width: 100%"><?php echo explode("/",$lec['data']['audio_link'])[2] ?></a>
                            </div>
                            <div class="col s4 m4">
                        ...
                        <div class="row">
                            <?php if(strlen($lec['data']['text_link']) > 10){ ?>
                                <div class="col s5 offset-s2">
                                    <a href="<?php echo $lec['data']['text_link'] ?>" download class="btn grey" style="width: 100%"> <?php echo explode("/",$lec['data']['text_link'])[2] ?></a>
                                </div>
                                <div class="col s4 m4">
                                    <span class="grey-text">Original script by <a href="profile.php?id=<?php echo $text_user['id'] ?>"><?php echo $text_user['username'] ?></a>
                                        <?php if(strlen($lec['data']['text_link']) > 10 and $text_user['id'] != $_SESSION['id']) echo "<br> You can't change file that you have not contributed yourself. Contact its contributor for collaboration."?>
                                    </span>
                                </div>
                            <?php } ?>
                        ...
                        <div class="row">
                            <?php if(strlen($lec['data']['sync_file_link']) > 10){ ?>
                                <div class="col s5 offset-s2">
                                    <a href="<?php echo $lec['data']['sync_file_link'] ?>" download class="btn grey" style="width: 100%"> <?php echo explode("/",$lec['data']['sync_file_link'])[2] ?></a>
                                </div>
                                <div class="col s4 m4">
                                    <span class="grey-text">Sync file by <a href="profile.php?id=<?php echo $sync_user['id'] ?>"><?php echo $sync_user['username'] ?></a
                                        <?php if(strlen($lec['data']['text_link']) > 10 and $text_user['id'] != $_SESSION['id']) echo "<br> You can't change file that you have not contributed yourself. Contact its contributor for collaboration."?>
                                    </span>
                        ...
                        <?php if($lec['trans'] != NULL){
                            foreach ($lec['trans'] as $trans){
                                ...
                                <div class="row">
                                    <div class="col s5 offset-s2">
                                        <a href="<?php echo $trans['trans_link'] ?>" download class="btn grey" style="width: 100%;"><?php echo explode("/",$trans['trans_link'])[2] . " (".$trans['l_name'].")" ?></a>
                                    </div>
                                    <div class="col s4 m4">
                                        <span class="grey-text">Parallel translation by <a href="profile.php?id=<?php echo $trans_user['id'] ?>"><?php echo $trans_user['username'] ?></a></span>
                                    </div>
                                </div>
                                <?php
                            }
